...
<!-- list -->
    ...
    <div class="container">
      ...
      <form action="<?php echo site_url('/Hewan/tambahhewan'); ?>" method="POST">
      <button class="btn"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</button>
      <br>
      <br>
       ...
       <table id="example" class="table table-striped table-bordered">
           ...
           <tbody>
             <?php foreach ( $adopsi as $key => $value) { ?>
              <tr>
              <td><?php echo $value->kode_adopsi; ?></td>
              <td><?php echo $value->username_member; ?></td>
              <td><?php echo $value->kode_hewan; ?></td>
              <td><?php echo $value->jenis_hewan; ?></td>
              <td><?php echo $value->status_adopsi; ?></td>

               <td>
            <a href="<?php echo site_url('Hewan/deleteadopsi/'.$value->kode_adopsi);?>"
              class="btn btn-danger" style="font-size:20px; padding: 10px;">
              <i class="fa fa-trash" aria-hidden="true"></i>
            </a>
            <a href="<?php echo site_url('Hewan/updateadopsi/'.$value->kode_adopsi.'/'.$value->kode_hewan); ?>"
