  ...
  <body>
    ...
    <!-- list -->
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0">update
    ...
    <div class="container">
      ...
      <div class="form-group">
        ...
        required value="<?php echo $username_member; ?>" readonly>
      </div>

      <div class="form-group">
        
        <input type="text" name="password_member" class="form-control" placeholder="Password" 
      ...
      <div class="form-group">
      <input type="text" name="alamat_member" class="form-control" placeholder="Alamat" 
        required value="<?php echo $alamat_member; ?>">
      </div>

      <div class="form-group">
       
        <input type="text" name="noHP_member" class="form-control" placeholder="No.Hp" 
        required value="<?php echo $noHP_member; ?>">
      </div>
      <div class="form-group">
      ...
      <a href="<?php echo site_url('Member/member')?>" class="btn btn-default">Cancel</a>
    </form>
    </div>
    </div>
</center>
