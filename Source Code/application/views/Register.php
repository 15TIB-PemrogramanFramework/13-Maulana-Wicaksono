            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo base_url()."index.php/Member/register" ?>" method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <input class="form-control" placeholder="Nama" name="nama_member" value="">
                                </div>
                                 <div class="form-group">
                                    <input class="form-control" placeholder="Alamat" name="alamat_member" value="">
                                </div>
                                 <div class="form-group">
                                    <input class="form-control" placeholder="No Handphone" name="noHP_member" value="">
                                </div>
