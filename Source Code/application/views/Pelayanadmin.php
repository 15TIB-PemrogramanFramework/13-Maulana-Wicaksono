...
<br>
       <table id="example" class="table table-striped table-bordered">
           ...
           <tbody>
             <?php foreach ( $pelayan as $key => $value) { ?>
              <tr>
              <td><?php echo $value->id_pelayan; ?></td>
              <td><?php echo $value->nama_pelayan; ?></td>
              <td><?php echo $value->umur_pelayan; ?></td>

               <td>
            <a href="<?php echo site_url('Pelayan/delete/'.$value->id_pelayan);?>"
              class="btn btn-danger" style="font-size:20px; padding: 10px;">
              <i class="fa fa-trash" aria-hidden="true"></i>
            </a>
            <a href="<?php echo site_url('Pelayan/update/'.$value->id_pelayan); ?>"
