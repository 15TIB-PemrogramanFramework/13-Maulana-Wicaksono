    ...
    <div class="container-fluid">
      ...
      <div class="bg-faded p-4 my-4">
        ...
        <h2 class="text-center text-lg text-uppercase my-0">FORM
          <strong>TITIP HEWAN</strong>
        </h2>
        <hr class="divider">
       
          <div class="panel-body">
                        <form role="form" action="<?php echo base_url()."index.php/Titip/tambahh" ?>" method="POST">
                            <fieldset>

                              <div class="form-group">
                                    <input class="form-control" placeholder="Username" name="username_member" value="<?php echo $this->session->userdata("username"); ?>" readonly>
                                </div>

                                <div class="form-group">
                                    <input class="form-control" placeholder="Jenis Hewan" name="jenis_hewan">
                                </div>

                                <div class="form-group">
                                  <select class="form-control" name="id_pelayan">
                                    <?php foreach ($titip as $row => $value) { ?>
                                      <option value="<?php echo $value->id_pelayan; ?>"><?php echo $value->spesialisasi; ?></option>
                                      <?php } ?>
                                  </select>
                                </div>
                                ...
                                <input type="submit" class="btn btn-lg btn-success btn-block" value="Titip" />
                            </fieldset>
                        </form>
                    </div>
