        ...
        <table id="example" class="table table-striped table-bordered">
           ...
           <tbody>
             <?php foreach ($hewan as $key => $value){?>
              <tr>
              <td><?php echo $value->jenis_hewan; ?></td>
              <td><?php echo $value->umur_hewan; ?></td>
              <td><?php echo $value->status_hewan; ?></td>
              <td><img style="width: 200px; height: auto;" width="50%" height="50%" src="<?php echo base_url()?>/assets/uploads/<?php echo $value->gambar_hewan; ?>"></td>
              <td>
                <form action="<?php echo site_url('/Hewan/adopsi'); ?>" method="POST">
                  <input type="hidden" name="kode_hewan" value="<?php echo $value->kode_hewan; ?>">
                  <input type="hidden" name="jenis_hewan" value="<?php echo $value->jenis_hewan; ?>">
                  <input type="hidden" name="status_hewan" value="<?php echo $value->status_hewan; ?>">
                  <button class="btn" type="submit">Adopsi</button>
