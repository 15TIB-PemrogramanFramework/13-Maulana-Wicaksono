    ...
    <div class="container">
      <div class="row">
       ...
       <table id="example" class="table table-striped table-bordered">
           ...
           <tbody>
             <?php foreach ( $titip as $key => $value) { ?>
              <tr>
              <td><?php echo $value->kode_titip; ?></td>
              <td><?php echo $value->username_member; ?></td>
              <td><?php echo $value->id_pelayan; ?></td>
              <td><?php echo $value->jenis_hewan; ?></td>
              <td><?php echo $value->status; ?></td>

               <td>
            <a href="<?php echo site_url('Titip/deletetitip/'.$value->kode_titip);?>"
              class="btn btn-danger" style="font-size:20px; padding: 10px;">
              <i class="fa fa-trash" aria-hidden="true"></i>
            </a>
            <a href="<?php echo site_url('Titip/updatetitip/'.$value->kode_titip); ?>"
