            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo base_url()."index.php/Hewan/tambahhewanaksi" ?>" method="POST" enctype="multipart/form-data">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Jenis Hewan" name="jenis_hewan" type="nama_pelayan">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Umur Hewan" name="umur_hewan">
                                </div>

                                <div class="form-group">
                                <input type="file" name="gambar_hewan" class="form-control">
                                </div>

                                <input type="submit" class="btn btn-lg btn-success btn-block" value="Submit" />
                                 <a href="<?php echo site_url('/Hewan/adopsiadmin'); ?>" class="btn btn-default">Cancel</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
